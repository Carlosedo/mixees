...
from apps.ingredients.views import MixerCreateView, IngredientCreateView, MixerIngredientCreateView, IngredientDeleteView
from apps.ingredients.views import MixerIngredientDeleteView
