...
from cocktails.views import IngredientListView, SpiritDetailView, MixerDetailView, SpiritCreateView
from cocktails.views import MixerCreateView, CocktailListView, CocktailDetailView, CocktailCreateView
from cocktails.views import CocktailUpdateView, IngredientCreateView, MixerIngredientCreateView, IngredientDeleteView
from cocktails.views import MixerIngredientDeleteView
